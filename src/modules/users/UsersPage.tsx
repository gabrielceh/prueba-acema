...
export  function UsersPage() {
  ...
  if(queryUsers.isLoading){
    return <main className='w-full min-h-dvh flex justify-center items-center'>
      <Loader/>
    </main>
  }
  ...
  return (
    <main className=''>
      ...
      <section className='flex items-center justify-center w-full'>
        <Pagination currentPage={currentPage} totalPages={totalPages} onNext={onNextPage} onPrev={onPrevPage}/>
      </section>
    </main>
  )
}
